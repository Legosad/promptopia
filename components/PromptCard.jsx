...
const PromptCard = ({ post, handleTagClick, handleEdit, handleDelete, handleUsernameClick }) => {
      ...
      <div className="flex justify-between items-start gap-5">
        <div className='flex-1 flex justify-start items-center gap-3 cursor-pointer'>
          ...
          <div className="flex flex-col">
            <h3 onClick={() => handleUsernameClick && handleUsernameClick(post.creator)} className='font-satoshi font-semibold text-gray-900 hover:text-sky-500'>{post.creator.username}</h3>
